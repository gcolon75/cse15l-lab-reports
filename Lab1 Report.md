...
However if you not installed it visit the link [Link](https://code.visualstudio.com/)
...
Follow this link [Link](https://gitforwindows.org) and install git for your device.
